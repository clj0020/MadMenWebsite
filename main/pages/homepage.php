...
<HTML>
  ...
  <body>
          ...
          <div class="row top">
            ...
            <div class="row middle">
              <div class="col-lg-12 middle-col">
                  <h1 class="animated bounceInLeft text-center">Bring your Ideas to Life</h1>
              </div>
            </div>
    ...
    <section class="touch-of-madness">
      <div class="container-fluid">
        <div class="row" id="touch-of-madness">
          <div class="col-lg-12">
            <p class="text-center">with a</p>
            <h1 class="text-center">Touch of Madness</h1>
            <img class="img-responsive" src="../img/responsive-screens.png"/>
            <h1 class="text-center">Anything is possible.</h1>
          </div>
        </div>
    ...
    <section class="roots-in-auburn">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
              <h1 class="text-center">with Roots in Auburn</h1>
          </div>
        </div>
      </div>
    </section>
